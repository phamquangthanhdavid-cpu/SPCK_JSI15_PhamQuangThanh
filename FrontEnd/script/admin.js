...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function uploadProductImage(imageFile) {
        ...
        var storageRef = firebase.storage().ref().child("products/" + fileName);
        ...
        db.collection("product").get()
            .then(function (querySnapshot) {
                if (querySnapshot.empty) {
                    productsContainer.innerHTML = "<div class=\"alert alert-info\">Chưa có sản phẩm nào.</div>";
                    return;
                }
            ...
            .catch(function (error) {
                ...
                productsContainer.innerHTML = "<div class=\"alert alert-danger\">Không tải được danh sách sản phẩm.</div>";
            });
    }
